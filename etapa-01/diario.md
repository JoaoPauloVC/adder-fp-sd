...
![GtkWave Signals](01-gtkwave-signals.png)

Dentro, selecionei os sinais que quer ver (todos os do TestBench, neste primeiro momento).

![GtkWave Signals Selected](02-gtkwave-signals-selected.png)
...
![GtkWave Signals Formatted](03-gtkwave-signal-formatted.png)
