...
end fp_adder_tratado ; --

architecture arch of fp_adder_tratado is --
    -- suffix b, s, a, n for --
...
begin --
    ...
    -- Identifica o operando de maior magnitude --
    ...
    -- Desloca a fração menor de acordo com a diferença dos expoentes --
    exp_diff <= expb - exps ; --
    ...
    -- Soma quando sinais iguais ou subtrai quando são diferentes --
    sum <= --
        ( '0' & fracb ) + ( '0' & fraca ) when signb = signs else --
        ( '0' & fracb ) - ( '0' & fraca ) ; --

    -- 4th stage : normalize --
    -- Conta zeros, desloca fração e ajusta expoente --
    -- count leading 0s --
